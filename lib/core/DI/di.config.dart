...
import 'package:menu2/data/datasources/supabase_dish_source.dart' as _i73;
...
extension GetItInjectableX on _i174.GetIt {
  ...
  _i174.GetIt init({
    ...
    gh.lazySingleton<_i73.SupabaseDishSource>(() => _i73.SupabaseDishSource());
    gh.lazySingleton<_i551.DishRepository>(
      () => _i979.DishRepositoryImpl(gh<_i73.SupabaseDishSource>()),
    );
